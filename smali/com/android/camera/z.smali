...
.method public static a(Landroid/graphics/BitmapFactory$Options;II)I
    ...
    .prologue
    .line 98
    invoke-static {p0, p1, p2}, Lcom/android/camera/z;->b(Landroid/graphics/BitmapFactory$Options;II)I
...
.method public static a(IILandroid/net/Uri;Landroid/content/ContentResolver;Landroid/os/ParcelFileDescriptor;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    :try_start_0
    invoke-static {p2, p3}, Lcom/android/camera/z;->a(Landroid/net/Uri;Landroid/content/ContentResolver;)Landroid/os/ParcelFileDescriptor;
    :try_end_0
    ...
    .line 323
    invoke-static {p4}, Lcom/android/camera/z;->a(Landroid/os/ParcelFileDescriptor;)V
    ...
    .line 307
    invoke-static {}, Lcom/android/camera/a;->a()Lcom/android/camera/a;

    move-result-object v2

    invoke-virtual {v2, v1, p5}, Lcom/android/camera/a;->a(Ljava/io/FileDescriptor;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    :cond_4
    :try_start_2
    invoke-static {p5, p0, p1}, Lcom/android/camera/z;->a(Landroid/graphics/BitmapFactory$Options;II)I
...
.method public static a(IILandroid/net/Uri;Landroid/content/ContentResolver;Z)Landroid/graphics/Bitmap;
    ...
    .line 276
    :try_start_1
    invoke-static {}, Lcom/android/camera/z;->a()Landroid/graphics/BitmapFactory$Options;
    ...
    .line 278
    invoke-static/range {v0 .. v5}, Lcom/android/camera/z;->a(IILandroid/net/Uri;Landroid/content/ContentResolver;Landroid/os/ParcelFileDescriptor;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    :try_end_1
    ...
    .line 283
    invoke-static {v4}, Lcom/android/camera/z;->a(Landroid/os/ParcelFileDescriptor;)V
...
.method public static a(Lcom/android/camera/MonitoredActivity;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Runnable;Landroid/os/Handler;)V
    .locals 3
    .parameter
    .parameter
    .parameter
    ...
    new-instance v2, Lcom/android/camera/aa;

    invoke-direct {v2, p0, p3, v0, p4}, Lcom/android/camera/aa;-><init>(Lcom/android/camera/MonitoredActivity;Ljava/lang/Runnable;Landroid/app/ProgressDialog;Landroid/os/Handler;)V
