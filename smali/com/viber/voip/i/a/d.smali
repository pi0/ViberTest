.class public Lcom/viber/voip/i/a/d;
...
.method public query(Landroid/database/sqlite/SQLiteDatabase;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    .prologue
    .line 20
    const-string/jumbo v0, "phonebookcontact._id"

    .line 21
    const-string/jumbo v1, "phonebookrawcontact.contact_id"
    ...
    const-string/jumbo v3, "phonebookcontact"

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    const-string/jumbo v3, " LEFT OUTER JOIN "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    const-string/jumbo v3, "phonebookrawcontact"
    ...
    invoke-direct {p0, v0}, Lcom/viber/voip/i/a/d;->a(Ljava/lang/String;)V
