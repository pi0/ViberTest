...
.method private static declared-synchronized retrieveTestAccountsForAppIfNeeded()V
    ...
    .line 228
    const-string/jumbo v0, "SELECT id,access_token FROM test_account WHERE app_id = %s"
    ...
    .line 231
    const-string/jumbo v2, "SELECT uid,name FROM user WHERE uid IN (SELECT id FROM #test_accounts)"
    ...
    .line 239
    const-string/jumbo v5, "test_accounts"
    ...
    const-string/jumbo v2, "Unexpected number of results from FQL query"
