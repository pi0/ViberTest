...
.field public static final MY_FEED:Ljava/lang/String; = "me/feed"
...
.method public constructor <init>(Lcom/facebook/Session;Ljava/lang/String;Landroid/os/Bundle;Lcom/facebook/HttpMethod;Lcom/facebook/Request$Callback;)V
    ...
    const-string/jumbo v2, "fbsdk:20121026"
...
.method static createConnection(Ljava/lang/String;)Lcom/viber/voip/util/http/HttpRequest;
    .locals 3
    .parameter
...
.method public static executeBatchAndWait(Lcom/facebook/RequestBatch;)Ljava/util/List;
    ...
    .line 1048
    :try_start_0
    invoke-static {p0}, Lcom/facebook/Request;->toHttpConnection(Lcom/facebook/RequestBatch;)Lcom/viber/voip/util/http/HttpRequest;
    :try_end_0
    ...
    .line 1055
    invoke-static {v0, p0}, Lcom/facebook/Request;->executeConnectionAndWait(Lcom/viber/voip/util/http/HttpRequest;Lcom/facebook/RequestBatch;)Ljava/util/List;
    ...
    invoke-static {v1, v2, v3}, Lcom/facebook/Response;->constructErrorResponses(Ljava/util/List;Lcom/viber/voip/util/http/HttpRequest;Lcom/facebook/FacebookException;)Ljava/util/List;
...
.method public static executeConnectionAndWait(Lcom/viber/voip/util/http/HttpRequest;Lcom/facebook/RequestBatch;)Ljava/util/List;
    .locals 6
    .parameter
    .parameter
    .annotation system Ldalvik/annotation/Signature;
    ...
    .prologue
    .line 1156
    invoke-static {p0, p1}, Lcom/facebook/Response;->fromHttpConnection(Lcom/viber/voip/util/http/HttpRequest;Lcom/facebook/RequestBatch;)Ljava/util/List;

    move-result-object v1

    .line 1158
    invoke-static {p0}, Lcom/facebook/internal/Utility;->disconnectQuietly(Lcom/viber/voip/util/http/HttpRequest;)V
...
.method public static executeConnectionAndWait(Ljava/net/HttpURLConnection;Ljava/util/Collection;)Ljava/util/List;
    ...
    invoke-static {p0, v0}, Lcom/facebook/Request;->executeConnectionAndWait(Ljava/net/HttpURLConnection;Ljava/util/Collection;)Ljava/util/List;
...
.method static final serializeToUrlConnection(Lcom/facebook/RequestBatch;Lcom/viber/voip/util/http/HttpRequest;)V
    .locals 8
    .parameter
    .parameter
    ...
    invoke-interface {p1}, Lcom/viber/voip/util/http/HttpRequest;->getUrl()Ljava/lang/String;
    ...
    invoke-interface {p1}, Lcom/viber/voip/util/http/HttpRequest;->getRequestMethod()Ljava/lang/String;
    ...
    invoke-interface {p1, v6}, Lcom/viber/voip/util/http/HttpRequest;->setConnectTimeout(I)V
    ...
    invoke-interface {p1, v6}, Lcom/viber/voip/util/http/HttpRequest;->setReadTimeout(I)V
    ...
    invoke-interface {p1}, Lcom/viber/voip/util/http/HttpRequest;->getOutputStream()Ljava/io/OutputStream;
    ...
    :cond_6
    :try_start_2
    const-string/jumbo v4, "batch_app_id"
...
.method public static toHttpConnection(Lcom/facebook/RequestBatch;)Lcom/viber/voip/util/http/HttpRequest;
    .locals 3
    .parameter
    ...
    invoke-static {v0}, Lcom/facebook/Request;->createConnection(Ljava/lang/String;)Lcom/viber/voip/util/http/HttpRequest;

    move-result-object v0

    .line 954
    invoke-static {p0, v0}, Lcom/facebook/Request;->serializeToUrlConnection(Lcom/facebook/RequestBatch;Lcom/viber/voip/util/http/HttpRequest;)V
    :try_end_1
    ...
    const-string/jumbo v1, "https://graph.facebook.com"
...
.method public static toHttpConnection(Ljava/util/Collection;)Lcom/viber/voip/util/http/HttpRequest;
    .locals 1
    .parameter
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    invoke-static {v0}, Lcom/facebook/Request;->toHttpConnection(Lcom/facebook/RequestBatch;)Lcom/viber/voip/util/http/HttpRequest;
...
.method public static varargs toHttpConnection([Lcom/facebook/Request;)Lcom/viber/voip/util/http/HttpRequest;
    .locals 1
    .parameter
    ...
    invoke-static {v0}, Lcom/facebook/Request;->toHttpConnection(Ljava/util/Collection;)Lcom/viber/voip/util/http/HttpRequest;
...
.method final getUrlForSingleRequest()Ljava/lang/String;
    ...
    const-string/jumbo v1, "https://api.facebook.com/method/"
