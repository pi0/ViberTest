...
.method constructor <init>(Lcom/facebook/Request;Lcom/viber/voip/util/http/HttpRequest;Lcom/facebook/FacebookRequestError;)V
    .locals 1
    .parameter
    .parameter
    .parameter
    ...
    .line 90
    iput-object p2, p0, Lcom/facebook/Response;->req:Lcom/viber/voip/util/http/HttpRequest;
...
.method constructor <init>(Lcom/facebook/Request;Lcom/viber/voip/util/http/HttpRequest;Lcom/facebook/model/GraphObject;Z)V
    .locals 1
    .parameter
    .parameter
    .parameter
...
.method constructor <init>(Lcom/facebook/Request;Lcom/viber/voip/util/http/HttpRequest;Lcom/facebook/model/GraphObjectList;Z)V
    .locals 1
    .parameter
    .parameter
    .parameter
...
.method static constructErrorResponses(Ljava/util/List;Lcom/viber/voip/util/http/HttpRequest;Lcom/facebook/FacebookException;)Ljava/util/List;
    .locals 6
    .parameter
    .parameter
    .parameter
    ...
    invoke-direct {v5, p1, p2}, Lcom/facebook/FacebookRequestError;-><init>(Lcom/viber/voip/util/http/HttpRequest;Ljava/lang/Exception;)V

    invoke-direct {v4, v0, p1, v5}, Lcom/facebook/Response;-><init>(Lcom/facebook/Request;Lcom/viber/voip/util/http/HttpRequest;Lcom/facebook/FacebookRequestError;)V
...
.method private static createResponseFromObject(Lcom/facebook/Request;Lcom/viber/voip/util/http/HttpRequest;Ljava/lang/Object;ZLjava/lang/Object;)Lcom/facebook/Response;
    .locals 3
    .parameter
    .parameter
    .parameter
    ...
    .line 409
    invoke-static {p2, p4, p1}, Lcom/facebook/FacebookRequestError;->checkResponseAndCreateError(Lorg/json/JSONObject;Ljava/lang/Object;Lcom/viber/voip/util/http/HttpRequest;)Lcom/facebook/FacebookRequestError;
    ...
    invoke-direct {v0, p0, p1, v1}, Lcom/facebook/Response;-><init>(Lcom/facebook/Request;Lcom/viber/voip/util/http/HttpRequest;Lcom/facebook/FacebookRequestError;)V
    ...
    invoke-direct {v0, p0, p1, v1, p3}, Lcom/facebook/Response;-><init>(Lcom/facebook/Request;Lcom/viber/voip/util/http/HttpRequest;Lcom/facebook/model/GraphObject;Z)V
    ...
    invoke-direct {v0, p0, p1, v1, p3}, Lcom/facebook/Response;-><init>(Lcom/facebook/Request;Lcom/viber/voip/util/http/HttpRequest;Lcom/facebook/model/GraphObjectList;Z)V
    ...
    invoke-direct {v1, p0, p1, v0, p3}, Lcom/facebook/Response;-><init>(Lcom/facebook/Request;Lcom/viber/voip/util/http/HttpRequest;Lcom/facebook/model/GraphObject;Z)V
...
.method private static createResponsesFromObject(Lcom/viber/voip/util/http/HttpRequest;Ljava/util/List;Ljava/lang/Object;Z)Ljava/util/List;
    .locals 7
    .parameter
    .parameter
    .parameter
    ...
    invoke-interface {p0}, Lcom/viber/voip/util/http/HttpRequest;->getResponseCode()I
    ...
    invoke-direct {v6, p0, v1}, Lcom/facebook/FacebookRequestError;-><init>(Lcom/viber/voip/util/http/HttpRequest;Ljava/lang/Exception;)V

    invoke-direct {v5, v0, p0, v6}, Lcom/facebook/Response;-><init>(Lcom/facebook/Request;Lcom/viber/voip/util/http/HttpRequest;Lcom/facebook/FacebookRequestError;)V
    ...
    .line 393
    invoke-static {v0, p0, v3, p3, p2}, Lcom/facebook/Response;->createResponseFromObject(Lcom/facebook/Request;Lcom/viber/voip/util/http/HttpRequest;Ljava/lang/Object;ZLjava/lang/Object;)Lcom/facebook/Response;
    ...
    invoke-direct {v6, p0, v3}, Lcom/facebook/FacebookRequestError;-><init>(Lcom/viber/voip/util/http/HttpRequest;Ljava/lang/Exception;)V
...
.method static createResponsesFromStream(Ljava/io/InputStream;Lcom/viber/voip/util/http/HttpRequest;Lcom/facebook/RequestBatch;Z)Ljava/util/List;
    .locals 10
    .parameter
    .parameter
    .parameter
    ...
    .line 344
    invoke-static {p1, p2, v1, p3}, Lcom/facebook/Response;->createResponsesFromObject(Lcom/viber/voip/util/http/HttpRequest;Ljava/util/List;Ljava/lang/Object;Z)Ljava/util/List;
...
.method static fromHttpConnection(Lcom/viber/voip/util/http/HttpRequest;Lcom/facebook/RequestBatch;)Ljava/util/List;
    .locals 8
    .parameter
    .parameter
    .annotation system Ldalvik/annotation/Signature;
    ...
    :try_start_1
    invoke-static {v2, v0, p1, v4}, Lcom/facebook/Response;->createResponsesFromStream(Ljava/io/InputStream;Lcom/viber/voip/util/http/HttpRequest;Lcom/facebook/RequestBatch;Z)Ljava/util/List;
    :try_end_1
    ...
    .line 307
    invoke-interface {p0}, Lcom/viber/voip/util/http/HttpRequest;->getErrorStream()Ljava/io/InputStream;
    ...
    invoke-static {v1, p0, p1, v0}, Lcom/facebook/Response;->createResponsesFromStream(Ljava/io/InputStream;Lcom/viber/voip/util/http/HttpRequest;Lcom/facebook/RequestBatch;Z)Ljava/util/List;
    :try_end_2
    ...
    :cond_4
    :try_start_3
    invoke-interface {p0}, Lcom/viber/voip/util/http/HttpRequest;->getInputStream()Ljava/io/InputStream;
    ...
    .line 321
    invoke-static {p1, p0, v0}, Lcom/facebook/Response;->constructErrorResponses(Ljava/util/List;Lcom/viber/voip/util/http/HttpRequest;Lcom/facebook/FacebookException;)Ljava/util/List;
    :try_end_4
    ...
    invoke-static {p1, p0, v2}, Lcom/facebook/Response;->constructErrorResponses(Ljava/util/List;Lcom/viber/voip/util/http/HttpRequest;Lcom/facebook/FacebookException;)Ljava/util/List;
    :try_end_5
...
.method public final getHttpRequest()Lcom/viber/voip/util/http/HttpRequest;
    .locals 1

    .prologue
    .line 162
    iget-object v0, p0, Lcom/facebook/Response;->req:Lcom/viber/voip/util/http/HttpRequest;
