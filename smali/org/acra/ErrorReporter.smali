...
.method private static addUserDataToReport(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "Add user comment to "
    ...
    const-string/jumbo v3, "Loading Properties report to insert user comment."
    ...
    const-string/jumbo v2, "User comment not added: "
...
.method private deleteFile(Landroid/content/Context;Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "Could not deleted error report : "
...
.method private retrieveCrashData(Landroid/content/Context;)V
    ...
    .line 430
    const-string/jumbo v0, "acra.syslog.enable"
    ...
    const-string/jumbo v4, "READ_LOGS granted! ACRA can include LogCat and DropBox data."
    ...
    const-string/jumbo v0, "acra.deviceid.enable"
    ...
    const-string/jumbo v4, "READ_LOGS not allowed. ACRA will not include LogCat and DropBox data."
    ...
    const-string/jumbo v2, "Error while retrieving crash data"
    ...
    const-string/jumbo v4, "Package info unavailable"
...
.method private static saveCrashReportFile(Ljava/lang/String;Lorg/acra/CrashReportData;)Ljava/lang/String;
    ...
    const-string/jumbo v1, "Writing crash report file."
    ...
    const-string/jumbo v2, "An error occured while writing the report file..."
...
.method private static sendCrashReport(Landroid/content/Context;Lorg/acra/CrashReportData;)V
    ...
    const-string/jumbo v5, "ReportSender of class "
    ...
    const-string/jumbo v4, " failed but other senders completed their task. ACRA will not send this report again."
...
.method private static toString(Landroid/view/Display;)Ljava/lang/String;
    ...
    const-string/jumbo v3, "metrics.density=x"
    ...
    const-string/jumbo v3, "metrics.scaledDensity=x"
    ...
    const-string/jumbo v3, "metrics.widthPixels="
    ...
    const-string/jumbo v3, "metrics.heightPixels="
    ...
    const-string/jumbo v3, "metrics.xdpi="
    ...
    const-string/jumbo v3, "metrics.ydpi="
...
.method public approvePendingReports()V
    ...
    const-string/jumbo v1, "Mark all pending reports as approved."
    ...
    const-string/jumbo v6, "-approved.stacktrace"
...
.method declared-synchronized checkAndSendReports(Landroid/content/Context;Z)V
    ...
    const-string/jumbo v2, "#checkAndSendReports - start"
    ...
    const-string/jumbo v1, "#checkAndSendReports - finish"
    ...
    const-string/jumbo v2, "Failed to send crash reports"
    ...
    const-string/jumbo v3, "Failed to load crash report for "
    ...
    const-string/jumbo v3, "Failed to send crash report for "
...
.method public checkReportsOnApplicationStart()V
    ...
    const-string/jumbo v1, "About to start ReportSenderWorker from #checkReportOnApplicationStart"
...
.method public disable()V
    ...
    const-string/jumbo v2, "ACRA is disabled for "
    ...
    const-string/jumbo v1, "ACRA is disabled."
...
.method getCrashReportFilesList()[Ljava/lang/String;
    ...
    const-string/jumbo v1, "Trying to get ACRA reports but ACRA is not initialized."
    ...
    const-string/jumbo v3, "Looking for error files in "
    ...
    const-string/jumbo v1, "Application files directory does not exist! The application may not be installed correctly. Please try reinstalling."
...
.method handleException(Ljava/lang/Throwable;Lorg/acra/ReportingInteractionMode;)Lorg/acra/ErrorReporter$ReportsSenderWorker;
    ...
    invoke-direct {p0, v1}, Lorg/acra/ErrorReporter;->retrieveCrashData(Landroid/content/Context;)V
    ...
    invoke-virtual {v1, v6, v4}, Lorg/acra/CrashReportData;->put(Ljava/lang/Enum;Ljava/lang/Object;)Ljava/lang/Object;

    .line 737
    invoke-virtual {v5}, Ljava/io/PrintWriter;->close()V

    .line 740
    invoke-static {v0, v0}, Lorg/acra/ErrorReporter;->saveCrashReportFile(Ljava/lang/String;Lorg/acra/CrashReportData;)Ljava/lang/String;
    ...
    invoke-direct {v0, p0, v2}, Lorg/acra/ErrorReporter$ReportsSenderWorker;-><init>(Lorg/acra/ErrorReporter;Z)V

    .line 753
    sget-object v1, Lorg/acra/ACRA;->LOG_TAG:Ljava/lang/String;

    const-string/jumbo v2, "About to start ReportSenderWorker from #handleException"
    ...
    .line 759
    invoke-virtual {p0, v1}, Lorg/acra/ErrorReporter;->notifySendReport(Ljava/lang/String;)V
...
.method notifySendReport(Ljava/lang/String;)V
    ...
    const-string/jumbo v7, "Creating Notification for "
    ...
    .line 824
    const-string/jumbo v4, "REPORT_FILE_NAME"
...
.method public uncaughtException(Ljava/lang/Thread;Ljava/lang/Throwable;)V
    ...
    const-string/jumbo v2, "ACRA caught a "
    ...
    const-string/jumbo v2, " exception for "
    ...
    const-string/jumbo v2, ". Building report."
