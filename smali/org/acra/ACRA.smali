...
.method static checkCrashResources()V
    ...
    const-string/jumbo v1, "NOTIFICATION mode: you have to define at least the resNotifTickerText, resNotifTitle, resNotifText, resDialogText parameters in your application @ReportsCrashes() annotation."
...
.method public static getACRASharedPreferences()Landroid/content/SharedPreferences;
    ...
    const-string/jumbo v2, "Retrieve SharedPreferences "
    ...
    const-string/jumbo v1, "Retrieve application default SharedPreferences."
...
.method public static init(Landroid/app/Application;)V
    ...
    const-string/jumbo v4, "Set OnSharedPreferenceChangeListener."
    ...
    .line 229
    :try_start_0
    const-string/jumbo v4, "acra.disable"

    const-string/jumbo v0, "acra.enable"
...
.method private static initAcra()V
    ...
    const-string/jumbo v2, "ACRA is enabled for "
    ...
    const-string/jumbo v2, ", intializing..."
    ...
    const-string/jumbo v3, " reports will be sent by email (if accepted by user)."
    ...
    const-string/jumbo v3, " should be granted permission "
    ...
    const-string/jumbo v3, " if you want your crash reports to be sent. If you don\'t want to add this permission to your application you can also enable sending reports by email. If this is your will then provide your email address in @ReportsCrashes(mailTo=\"your.account@domain.com\""
