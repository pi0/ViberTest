  ...
  implements a
{
  ...
  public boolean A()
  {
    ...
    try
    {
      localParcel1.writeInterfaceToken("com.android.music.player.service.ICorePlayerService");
  ...
  public void a(int[] paramArrayOfInt)
  {
    ...
    //   23: aload_0
    //   24: getfield 15	com/android/music/player/a/c:a	Landroid/os/IBinder;
    //   27: bipush 25
    //   29: aload_2
    //   30: aload_3
    //   31: iconst_0
    //   32: invokeinterface 35 5 0
    //   37: pop
    //   38: aload_3
    //   39: invokevirtual 38	android/os/Parcel:readException	()V
    //   42: aload_3
    //   43: aload_1
    //   44: invokevirtual 72	android/os/Parcel:readIntArray	([I)V
    //   47: aload_3
  ...
  /* Error */
  public com.android.music.player.data.MusicAlbumInfo g()
  {
    // Byte code:
    //   0: invokestatic 23	android/os/Parcel:obtain	()Landroid/os/Parcel;
    //   3: astore_1
    ...
    //   11: invokevirtual 29	android/os/Parcel:writeInterfaceToken	(Ljava/lang/String;)V
    //   14: aload_0
    //   15: getfield 15	com/android/music/player/a/c:a	Landroid/os/IBinder;
    //   18: bipush 9
    //   20: aload_1
    //   21: aload_2
    //   22: iconst_0
    ...
    //   37: ifeq +28 -> 65
    //   40: getstatic 91	com/android/music/player/data/MusicAlbumInfo:CREATOR	Landroid/os/Parcelable$Creator;
    //   43: aload_2
    //   44: invokeinterface 97 2 0
    //   49: checkcast 87	com/android/music/player/data/MusicAlbumInfo
    //   52: astore 5
    //   54: aload_2
    ...
    //   52	15	5	localMusicAlbumInfo	com.android.music.player.data.MusicAlbumInfo
    // Exception table:
    //   from	to	target	type
    //   8	54	71	finally
  }
 ...
 * Qualified Name:     com.android.music.player.a.c
