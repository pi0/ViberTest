  ...
  extends SQLiteQueryBuilder
{
  ...
  {
    String str = "SELECT " + a.b(paramArrayOfString1) + " FROM " + "phonebookcontact" + " LEFT OUTER JOIN " + "phonebookrawcontact" + " ON (" + "phonebookcontact._id" + "=" + "phonebookrawcontact.contact_id" + ")";
 ...
 * Qualified Name:     com.viber.voip.i.a.d
