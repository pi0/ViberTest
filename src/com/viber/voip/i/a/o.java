  ...
  extends SQLiteQueryBuilder
{
  ...
  {
    String str = "SELECT " + a.b(paramArrayOfString1) + " FROM " + "phonebookdata" + " LEFT OUTER JOIN " + "phonebookcontact" + " ON (" + "phonebookcontact._id" + "=" + "phonebookdata.contact_id" + ")";
 ...
 * Qualified Name:     com.viber.voip.i.a.o
