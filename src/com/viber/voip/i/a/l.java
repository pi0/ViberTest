  ...
  extends SQLiteQueryBuilder
{
  ...
  {
    String str = "SELECT " + a.b(paramArrayOfString1) + " FROM " + "messages" + " LEFT OUTER JOIN " + "participants" + " ON (" + "messages.participant_id" + "=" + "participants._id" + ")" + " LEFT OUTER JOIN " + "public_messages_extras" + " ON (" + "messages.token" + "=" + "public_messages_extras.message_token" + ")" + " LEFT OUTER JOIN " + "participants_info" + " ON (" + "participants.participant_info_id" + "=" + "participants_info._id" + ")";
 ...
 * Qualified Name:     com.viber.voip.i.a.l
