  ...
  extends ValueAnimator
{
  ...
  public void setFloatValues(float... paramVarArgs)
  {
    if ((this.mValues == null) || (this.mValues.length == 0))
    {
      if (this.mProperty != null)
      {
        ...
        arrayOfPropertyValuesHolder2[0] = PropertyValuesHolder.ofFloat(this.mProperty, paramVarArgs);
        setValues(arrayOfPropertyValuesHolder2);
        return;
      }
      PropertyValuesHolder[] arrayOfPropertyValuesHolder1 = new PropertyValuesHolder[1];
      arrayOfPropertyValuesHolder1[0] = PropertyValuesHolder.ofFloat(this.mPropertyName, paramVarArgs);
  ...
  public void setIntValues(int... paramVarArgs)
  {
    if ((this.mValues == null) || (this.mValues.length == 0))
    {
      ...
      {
        PropertyValuesHolder[] arrayOfPropertyValuesHolder2 = new PropertyValuesHolder[1];
        arrayOfPropertyValuesHolder2[0] = PropertyValuesHolder.ofInt(this.mProperty, paramVarArgs);
        setValues(arrayOfPropertyValuesHolder2);
        return;
      }
      PropertyValuesHolder[] arrayOfPropertyValuesHolder1 = new PropertyValuesHolder[1];
      arrayOfPropertyValuesHolder1[0] = PropertyValuesHolder.ofInt(this.mPropertyName, paramVarArgs);
      setValues(arrayOfPropertyValuesHolder1);
      return;
    }
  ...
  public void setObjectValues(Object... paramVarArgs)
  {
    if ((this.mValues == null) || (this.mValues.length == 0))
    {
      ...
      {
        PropertyValuesHolder[] arrayOfPropertyValuesHolder2 = new PropertyValuesHolder[1];
        arrayOfPropertyValuesHolder2[0] = PropertyValuesHolder.ofObject(this.mProperty, (TypeEvaluator)null, paramVarArgs);
        setValues(arrayOfPropertyValuesHolder2);
        return;
      }
      PropertyValuesHolder[] arrayOfPropertyValuesHolder1 = new PropertyValuesHolder[1];
      arrayOfPropertyValuesHolder1[0] = PropertyValuesHolder.ofObject(this.mPropertyName, (TypeEvaluator)null, paramVarArgs);
      setValues(arrayOfPropertyValuesHolder1);
      return;
    }
