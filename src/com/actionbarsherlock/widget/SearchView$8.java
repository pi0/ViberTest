    ...
    do
    {
      do
      {
        ...
        if ((SearchView.access$1300(this.this$0).isPopupShowing()) && (SearchView.access$1300(this.this$0).getListSelection() != -1)) {
          return SearchView.access$1600(this.this$0, paramView, paramInt, paramKeyEvent);
        }
      } while ((SearchView.SearchAutoComplete.access$1700(SearchView.access$1300(this.this$0))) || (!KeyEventCompat.hasNoModifiers(paramKeyEvent)));
