...
public class IcsListPopupWindow
{
  ...
  private int buildDropDown()
  {
    ...
    if (this.mDropDownList == null)
    {
      ...
      {
        int i3 = i;
        this.mDropDownList = new IcsListPopupWindow.DropDownListView(localContext, i3);
    ...
    for (int i5 = localView2.getMeasuredHeight() + localLayoutParams3.topMargin + localLayoutParams3.bottomMargin;; i5 = 0)
    {
      ...
      for (;;)
      {
        ...
        for (int m = i2;; m = 0)
        {
          ...
          label472:
          int i1 = measureHeightOfChildren(0, 0, -1, n - k, -1);
          if (i1 > 0) {
            k += m;
          }
          return i1 + k;
