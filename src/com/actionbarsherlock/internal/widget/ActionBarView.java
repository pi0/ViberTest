  ...
  extends AbsActionBarView
{
  ...
  private static int loadLogoFromManifest(Activity paramActivity)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        n = localXmlResourceParser.nextToken();
        i = m;
        k = n;
      }
    ...
    for (;;)
    {
      ...
      if (i1 >= 0)
      {
        str5 = localXmlResourceParser.getAttributeName(i1);
        if ("logo".equals(str5)) {
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    label443:
    label958:
    for (int m = i + (i23 + positionChild(localHomeView, i + i23, j, k));; m = i)
    {
      int i22;
      if (this.mExpandedActionView == null)
      {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (localView1 != null)
        {
          ...
          label718:
          if (((i21 & 0x7) != 1) || (localLayoutParams1.width != -1)) {
            break label1318;
          }
        }
        label896:
        ...
        label1311:
        label1318:
        for (int i22 = 2 * Math.min(i9, i5);; i22 = i20)
        {
