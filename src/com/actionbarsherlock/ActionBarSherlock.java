...
public abstract class ActionBarSherlock
{
  ...
  protected final boolean callbackCreateOptionsMenu(com.actionbarsherlock.view.Menu paramMenu)
  {
    ...
    while (!(this.mActivity instanceof ActionBarSherlock.OnCreateOptionsMenuListener)) {
      return bool;
    }
    return ((ActionBarSherlock.OnCreateOptionsMenuListener)this.mActivity).onCreateOptionsMenu(paramMenu);
  }
  ...
  protected final boolean callbackOptionsItemSelected(com.actionbarsherlock.view.MenuItem paramMenuItem)
  {
    if ((this.mActivity instanceof ActionBarSherlock.OnMenuItemSelectedListener)) {
      return ((ActionBarSherlock.OnMenuItemSelectedListener)this.mActivity).onMenuItemSelected(0, paramMenuItem);
    }
    if ((this.mActivity instanceof ActionBarSherlock.OnOptionsItemSelectedListener)) {
      return ((ActionBarSherlock.OnOptionsItemSelectedListener)this.mActivity).onOptionsItemSelected(paramMenuItem);
    }
    return false;
  }
  ...
  protected final boolean callbackPrepareOptionsMenu(com.actionbarsherlock.view.Menu paramMenu)
  {
    ...
    while (!(this.mActivity instanceof ActionBarSherlock.OnPrepareOptionsMenuListener)) {
      return bool;
    }
    return ((ActionBarSherlock.OnPrepareOptionsMenuListener)this.mActivity).onPrepareOptionsMenu(paramMenu);
  }
